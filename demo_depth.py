...
from utils import copy_to_device, depth2pc
import os
...
class Demo:
    ...
    def prepare_images_and_depths(self):
        ...
        depth2 = read_depth(args.depth2)

        # lift depth maps into point clouds
        pc1 = depth2pc(depth1, args.f, args.cx, args.cy)
        pc2 = depth2pc(depth2, args.f, args.cx, args.cy)
...
if __name__ == '__main__':
    ...
    # RGB input
    parser.add_argument('--image1', required=False, default='asserts/0000000005.png')
    parser.add_argument('--image2', required=False, default='asserts/0000000009.png')
    
    # depth input
    parser.add_argument('--depth1', required=False, default='asserts/depth/0000000005.png')
    parser.add_argument('--depth2', required=False, default='asserts/depth/0000000009.png')
    
    # depth -> point clouds
    parser.add_argument('--n_points', required=False, default=8192)
    parser.add_argument('--max_depth', required=False, default=90.0)
    
    # camera intrinsics
    parser.add_argument('--f', required=False, default=7.215377e+02)
    parser.add_argument('--cx', required=False, default=6.095593e+02)
    parser.add_argument('--cy', required=False, default=1.728540e+02)
